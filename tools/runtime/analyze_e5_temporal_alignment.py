...
FIELDS = [
    ...
    "anchor_error_m", "projected_anchor_error_m", "retained_tracking_limit_m", "sampled_path_clear",
    "committed_suffix_usable", "safety_suffix_usable",
    "execution_state_source_age_ms", "execution_state_receive_age_ms",
...
def direct_row(command: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "execution_state_source_age_ms": val("execution_state_source_age_ms"),
        "execution_state_receive_age_ms": val("execution_state_receive_age_ms"),
        ...
        "anchor_error_m": val("anchor_error_m"),
        "projected_anchor_error_m": val("projected_anchor_error_m"),
        ...
        "safety_suffix_usable": val("committed_suffix_usable"),
