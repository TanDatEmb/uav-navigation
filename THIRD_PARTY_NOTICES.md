...
| --- | --- | --- | --- |
| IKFoM | Vendored headers used by estimator integration | GPL-2.0-only upstream | [UPSTREAM.md](src/navigation_estimator/ikfom_vendor/UPSTREAM.md); license text at `src/navigation_estimator/ikfom_vendor/LICENSES/IKFoM-GPL-2.0.txt` |
| ikd-Tree | Vendored source used by registration-map integration and tests | GPL-2.0-only upstream | [UPSTREAM.md](src/navigation_estimator/ikd_tree_vendor/UPSTREAM.md); license text at `src/navigation_estimator/ikd_tree_vendor/LICENSES/ikd-Tree-GPL-2.0.txt` |
| ROG-Map / SUPER subset | Vendored navigation world-model source | Upstream metadata inconsistent: BSD package manifest and LGPL/GPL file headers | [UPSTREAM.md](src/navigation_mapping/rog_map_vendor/UPSTREAM.md); do not treat the package manifest alone as a resolved license determination |
| FAST-LIO | Algorithmic/reference provenance; no FAST-LIO source copied | GPL-2.0-only upstream | [IKFoM/FAST-LIO provenance](src/navigation_estimator/ikfom_vendor/UPSTREAM.md) |
...
required release licensing analysis, especially for the ROG-Map/SUPER subset
