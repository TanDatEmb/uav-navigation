...
- **H1_splice_continuity**: INCONCLUSIVE. Evidence records: 13.
- **H2_replanning_timing**: INCONCLUSIVE. Evidence records: 13.
- **H3_pass_through_continuation**: INCONCLUSIVE. Evidence records: 13.
- **H4_failed_replan_safety_takeover**: CONFIRMED. Evidence records: 14.
- **H4a_planning_failure_alone_changes_ownership**: INCONCLUSIVE. Evidence records: 13.
- **H4b_tracking_certificate_exhaustion_authorizes_emergency**: INCONCLUSIVE. Evidence records: 13.
- **H4c_backup_ownership_begins_at_declared_switch**: CONFIRMED. Evidence records: 14.
- **H5_corner_overconstraint**: INCONCLUSIVE. Evidence records: 13.
- **H6_px4_controller_mismatch**: INCONCLUSIVE. Evidence records: 13.
