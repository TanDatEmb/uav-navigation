...
namespace super_planner {
    ...
    public:
        ...
        explicit Config(
            ...
            loader.LoadParam("super_planner/safe_corridor_line_nominal_length",
            ...
            loader.LoadParam("super_planner/vehicle_radius_m", vehicle_radius_m, 0.35);
            loader.LoadParam("super_planner/tracking_error_budget_m", tracking_error_budget_m, 0.25);
            loader.LoadParam("super_planner/localization_error_budget_m", localization_error_budget_m, 0.05);
            loader.LoadParam("super_planner/mapping_error_budget_m", mapping_error_budget_m, 0.10);
            loader.LoadParam("super_planner/planning_margin_m", planning_margin_m, 0.05);
            ...
            if (!std::isfinite(resolution) || resolution <= 0.0 ||
                ...
                throw std::invalid_argument(
                    "SUPER safety geometry requires finite positive robot_r and "
