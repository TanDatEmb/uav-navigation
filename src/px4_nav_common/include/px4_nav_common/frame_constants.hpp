#ifndef PX4_NAV_COMMON_FRAME_CONSTANTS_HPP_
#define PX4_NAV_COMMON_FRAME_CONSTANTS_HPP_

#include <string_view>

namespace px4_nav_common::frame {
...
#endif  // PX4_NAV_COMMON_FRAME_CONSTANTS_HPP_
