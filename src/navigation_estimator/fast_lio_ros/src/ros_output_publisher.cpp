...
void RosOutputPublisher::publishTransportSnapshot(
  ...
  status.values = {
      ...
      keyValue("mapping_observation_publish_count",
               std::to_string(runtime.mapping_observation_publish_count)),
      keyValue("mapping_observation_publish_skip_count",
               std::to_string(runtime.mapping_observation_publish_skip_count)),
      keyValue("mapping_observation_skip_not_ready_count",
               std::to_string(runtime.mapping_observation_skip_not_ready_count)),
      keyValue("mapping_observation_skip_public_frame_invalid_count",
               std::to_string(runtime.mapping_observation_skip_public_frame_invalid_count)),
      keyValue("mapping_observation_last_sequence",
               std::to_string(runtime.mapping_observation_last_sequence)),
      keyValue("mapping_observation_stream_id",
               std::to_string(runtime.mapping_observation_stream_id)),
      keyValue("pose_covariance_available",
