...
void RosOutputPublisher::publishDiagnostics(const ProcessResult& result,
  ...
  status.values = {
      ...
      keyValue("initial_prior_covariance_applied",
               result.diagnostics.initial_prior.covariance_applied ? "true" : "false"),
      keyValue("initial_prior_propagated_to_application",
               result.diagnostics.initial_prior.propagated_to_application ? "true" : "false"),
      keyValue("initial_prior_candidate_timestamp_ns",
               std::to_string(result.diagnostics.initial_prior.candidate_timestamp_ns)),
      keyValue("initial_prior_state_time_ns",
               std::to_string(result.diagnostics.initial_prior.state_time_ns)),
      ...
      keyValue("initial_prior_accepted_count",
               std::to_string(result.diagnostics.initial_prior.accepted_count)),
      keyValue("initial_prior_rejected_count",
               std::to_string(result.diagnostics.initial_prior.rejected_count)),
      keyValue("initial_prior_late_rejected_count",
               std::to_string(result.diagnostics.initial_prior.late_rejected_count)),
      ...
      keyValue("initial_prior_frame_rejected_count",
               std::to_string(result.diagnostics.initial_prior.frame_rejected_count)),
      keyValue("initial_prior_timestamp_rejected_count",
               std::to_string(result.diagnostics.initial_prior.timestamp_rejected_count)),
      keyValue("initial_prior_invalid_value_count",
               std::to_string(result.diagnostics.initial_prior.invalid_value_count)),
      ...
      keyValue("prediction_attempted",
               result.diagnostics.prediction.attempted ? "true" : "false"),
      keyValue("prediction_successful",
               result.diagnostics.prediction.successful ? "true" : "false"),
      keyValue("prediction_start_time_ns",
               std::to_string(result.diagnostics.prediction.start_time_ns)),
      keyValue("prediction_end_time_ns",
               std::to_string(result.diagnostics.prediction.end_time_ns)),
      keyValue("prediction_interval_ns",
               std::to_string(result.diagnostics.prediction.interval_ns)),
      keyValue("prediction_imu_first_time_ns",
               std::to_string(result.diagnostics.prediction.imu_first_time_ns)),
      keyValue("prediction_imu_last_time_ns",
               std::to_string(result.diagnostics.prediction.imu_last_time_ns)),
      keyValue("prediction_imu_sample_count",
               std::to_string(result.diagnostics.prediction.imu_sample_count)),
      keyValue("prediction_integration_interval_count",
               std::to_string(result.diagnostics.prediction.integration_interval_count)),
      keyValue("prediction_rejection_reason",
               result.diagnostics.prediction.rejection_reason),
