...
// From HKU MARS Lab: https://github.com/hku-mars/ikd-Tree
// Adapted for FAST-LIO2 UAV navigation (ROS2 compatible)
//
// Note: Uses pthread directly for real-time performance.
// This is intentional - pthread provides better control for
// the rebuild thread than std::thread in real-time contexts.
#pragma once
#include <stdio.h>
#include <queue>
#include <pthread.h>
