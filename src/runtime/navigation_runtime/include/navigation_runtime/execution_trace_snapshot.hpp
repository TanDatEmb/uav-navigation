...
struct ExecutionTraceSnapshot final {
  ...
  double phase_execution_lag_s{std::numeric_limits<double>::quiet_NaN()};
  double phase_execution_source_error_m{std::numeric_limits<double>::quiet_NaN()};
  double phase_execution_predicted_error_m{std::numeric_limits<double>::quiet_NaN()};
  double phase_execution_relative_velocity_mps{std::numeric_limits<double>::quiet_NaN()};
  bool phase_execution_certificate_accepted{false};
  std::int64_t phase_execution_final_evaluation_stamp_ns{0};
  std::int64_t phase_execution_final_source_stamp_ns{0};
  double phase_execution_final_lag_s{std::numeric_limits<double>::quiet_NaN()};
  double phase_execution_final_source_error_m{std::numeric_limits<double>::quiet_NaN()};
  double phase_execution_final_predicted_error_m{std::numeric_limits<double>::quiet_NaN()};
