...
class NavigationMode final : public px4_ros2::ModeBase {
 ...
 private:
  ...
  rclcpp::Subscription<mars_quadrotor_msgs::msg::PolynomialTrajectory>::SharedPtr
      super_trajectory_subscription_;
  ...
  std::string super_trajectory_topic_;
  std::string goal_topic_;
  std::string planner_heartbeat_topic_;
  ...
  std::optional<SuperPolynomialTrajectory> super_trajectory_;
