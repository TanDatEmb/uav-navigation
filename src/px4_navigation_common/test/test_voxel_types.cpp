...
using px4_navigation_common::mapping::kDefaultVoxelResolutionM;
using px4_navigation_common::mapping::kEvictRadiusM;
using px4_navigation_common::mapping::kInflationVoxels;
using px4_navigation_common::mapping::kLogOddsHit;
using px4_navigation_common::mapping::kLogOddsMax;
using px4_navigation_common::mapping::kLogOddsMin;
using px4_navigation_common::mapping::kLogOddsMiss;
using px4_navigation_common::mapping::kLogOddsOccupiedThreshold;
using px4_navigation_common::mapping::kMaxRayLengthM;
using px4_navigation_common::mapping::kVoxelPoolSize;
...
TEST(VoxelTypesTest, PoolSizeExceedsMaxVoxels) {
    EXPECT_GT(kVoxelPoolSize, px4_navigation_common::mapping::kMaxVoxels);
}
