...
- Mermaid CLI v11.17.0 was installed into an isolated temporary directory for this follow-up; no global install or browser download was performed. The four Mermaid sequence SVGs were rendered and visually checked with the system Chrome. Reproduction details are in [render tool provenance](render_tool_provenance.md).
- Seven Graphviz and four Mermaid SVGs were rendered and checked. The final `PARTIAL_AS_IS` status reflects the remaining source writer/profile/runtime gaps.
