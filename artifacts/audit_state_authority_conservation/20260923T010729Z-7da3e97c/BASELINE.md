...
Submodule gitlink revisions: `src/external/px4_msgs` `86d8239e962f6939e05c3737784f60c02fa884db`; `src/external/px4_ros2_interface_lib` `4a3370f084ac6f1ef001a4afa2b007845ffd0837`. They were initialized in the original checkout, **not initialized in the new audit worktree**. One targeted PX4 library source path was checked at the pinned gitlink and blob for Hold callback semantics; see `PX4_HOLD_ORDERING.md`. The new branch starts exactly at TARGET_SHA and contains only this artifact directory. No reset, clean, stash, rebase, force push or merge of old audit branches was used.
