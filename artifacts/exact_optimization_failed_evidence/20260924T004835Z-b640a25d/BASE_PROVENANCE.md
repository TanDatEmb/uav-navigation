...
- Post-run external drift: after all seven final sessions ended, this external PX4 binary was observed with SHA256 `b69d990830625c54de458282ff109286c5a35597680675bcad0a163ea8640edc` and mtime `2026-09-24 08:58:38 +07:00`. This work did not modify the external checkout. Each final session's immutable `metadata.json` records the same run-time binary SHA256 `e440bd77...`, PX4 checkout HEAD, and dirty inputs. No run using the changed binary is mixed into this verdict.
